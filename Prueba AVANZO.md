...
## 1.1. Razones trigonométricas[^1.1]
...
## 1.2. Solución y aplicación de triángulos rectángulos[^1.2]

## 1.3. Ángulo de elevación y de depresión[^1.3]

## 1.4. Operaciones entre intervalos: unión, intersección, complemento y diferencia[^1.4]

## 1.5. Desigualdades lineales en una variable. Problemas de desigualdades lineales[^1.5]

## 1.6. Términos estadísticos básicos: población, muestra, parámetro estadístico, parámetro[^1.6]

## 1.7. Organización de datos y presentación tabular[^1.7]

## 1.8. Presentaciones gráficas para variables discretas y atributos: barras, lineal, circular[^1.8]

## 1.9. Interpretación de datos en tablas y gráficas estadísticas[^1.9]

## 1.10. Distribución de clase y frecuencias: clase, límites de clase, ancho de clase, puntos medios, frecuencias absolutas, frecuencias relativas, frecuencias acumuladas[^1.10]

## 1.11. Presentación gráficas para variables continuas: histograma, polígono de frecuencias, ojiva[^1.11]

## 1.12. Medidas de tendencia central para datos simples y datos agrupados: media aritmética, mediana y moda, y su aplicación[^1.12]

## 1.13. Medidas de posición: cuartiles, deciles y percentiles[^1.13]

## 1.14. Medidas de dispersión: rango, desviación media, varianza, desviación típica, coeficiente de variabilidad y su aplicación[^1.14]

## 1.15. Propiedades de la media aritmética y la desviación típica[^1.15]

## 1.16. Plano cartesiano: localización de pares ordenados[^1.16]

## 1.17. Producto cartesiano[^1.17]

## 1.18. Gráficas de relaciones. Dominio y recorrido de una relación[^1.18]

## 1.19. Funciones: elementos y notación[^1.19]

## 1.20. Funciones algebraicas: constante, lineal, cuadrática, cúbica[^1.20]

## 1.21. Gráficas de funciones: dominio y recorrido[^1.21]

## 1.22. Función racional y función raíz cuadrada[^1.22]

## 1.23. Función inversa: función inyectiva[^1.23]

## 1.24. Dominio y recorrido de la inversa de una función[^1.24]

# 2. Ciencia Salud y Medio Ambiente

## 2.1. Características del conocimiento científico y las diferencias con el conocimiento empírico[^2.1]
...
## 2.2. Pasos y aplicación del método científico en situaciones cotidianas[^2.2]
...
#### 2.2.1.5. Pon a prueba las predicciones
...
## 2.3. Medidas directas e indirectas en situaciones reales[^2.3]
...
La distancia entre centros de agujeros o ejes (distancia L, entre agujeros en la figura) es un claro ejemplo de una medición indirecta.

Un caso particular de las indirectas, son las mediciones por comparación, en donde las mediciones se realizan con comparadores y patrones.

## 2.4. EI sistema internacional de medidas, problemas de conversión de unidades[^2.4]
...
Para convertir unidades, revisa la [**tabla de conversión de unidades**](https://agunsa.com/informacion-de-interes/tablas-de-conversion/), recuerda que se puede convertir entre unidades que midan la misma magnitud física (longitud con longitud, no longitud con peso).

## 2.5. Cantidades físicas escalares y vectoriales, operaciones básicas con vectores: suma y resta[^2.5]
...
![Suma de vectores](https://miprofe.com/wp-content/uploads/2016/03/vectorsuma.png)

Para restar dos vectores libres $\vec{u}$ y $\vec{v}$ y se suma con el opuesto de $\vec{v}$.
...
Ley de inercia: Un conductor de una patineta choca con un objeto inmóvil de manera brusca y, por inercia, sale disparado hacia adelante.
...
## 2.9. Reacciones endotérmicas y exotérmicas que afectan el medio ambiente[^2.9]

La transferencia de energía es una característica esencial de los cambios químicos. Por ejemplo, en el cuerpo humano, la energía es transferida de los alimentos, principalmente durante el metabolismo de los carbohidratos; en los autos, la energía mecánica se obtiene de la combustión de gasolina. En ambos casos, la energía es liberada a sus alrededores. Por el contrario, la fotosíntesis es un proceso que remueve energía de los alrededores, pues toma la energía radiante del Sol.

### 2.9.1. Reacciones endotérmicas y exotérmicas 

Según las reacciones vayan acompañadas de la cesión de energía o de absorción de energía, se denominan exotérmicas o endotérmicas. Cuando dos o más sustancias reaccionan y la temperatura de su mezcla decrece, y se absorbe energía de los alrededores, se llama reacción endotérmica; en cambio, cuando se libera energía en la reacción, se llama reacción exotérmica.

## 2.10. Estructura del átomo y modelos atómicos[^2.10]
...
![Modelos Atómicos](https://blog.unitips.mx/hs-fs/hubfs/36.png?width=1024&name=36.png)
...
## 2.12. Los principales tipos de enlace químico: iónico, covalente y metálico[^2.12]
...
#### 2.12.2.1. Enlace covalente no polar o puro
...
1. **Concentración:** La concentración de la solución señala la relación entre la cantidad de solvente y la cantidad de soluto. Las propiedades químicas del solvente y del soluto no se alteran en la solución.
2. **Soluto:** Componente de una solución que se encuentra en menor proporción y esta sustancia es disuelta por el solvente.
3. **Solvente:** Componente de una solución presente en mayor proporción y que disuelve al soluto dispersándolo en él. El solvente universal es el agua.
...
![Partes de una reacción química](https://oa.ugto.mx/oa/oa-rg-0001374/PARTES_REAC_Q.png)

### 2.14.2. Signos en una reacción química

![Signos en una reacción química](https://oa.ugto.mx/oa/oa-rg-0001374/SIMBOLOGIA.png)
...
Es el método para balancear ecuaciones químicas que consiste en que cada miembro de la ecuación química se tengan la misma cantidad de átomos, tanto de reactivos como de productos, para equilibrar ecuaciones, solo se agregan coeficientes a las fórmulas que lo necesiten, pero no se cambian los subíndices.

## 2.16. PH: Sustancias ácidas, básicas y neutras presentes en la naturaleza[^2.16]
...
![PH](https://www3.epa.gov/acidrain/education/site_students_spanish/images/phscale.gif)

## 2.17. Relación entre la velocidad de las reacciones químicas y temperatura[^2.17]
...
## 2.18. EI Átomo de carbono y los principales compuestos orgánicos: alcanos, alquenos, alquinos[^2.18]

Para nombrar y especificar el número de átomos de carbono en los compuestos orgánicos, se utilizan prefijos:
...
## 2.19. Composición y funciones de las biomoléculas[^2.19]
...
![Biomoléculas](https://image.isu.pub/180604192311-82a0b3141b7b476472b5d5e780c2ad24/jpg/page_1.jpg)

### 2.19.1. Clasificación

![Clasificación](https://www.bionova.org.es/biocast/neotem1.jpg)

## 2.20. Primeras explicaciones al origen de la vida[^2.20]

### 2.20.1. Teoría del Caldo Primordial, de Alexandr Ivánovich Oparin
...
### 2.20.2. La teoría de Miller y su experimento
...
### 2.20.3. La teoría de las microesferas de proteinoides, de Fox
...
### 2.20.4. Teoría de la panspermia
...
### 2.20.5. Teoría del Mundo del ARN
